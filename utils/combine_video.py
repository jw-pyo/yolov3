...
out.open('test.avi', fourcc, 10, (1640, 720), True)

cap1 = cv2.VideoCapture('../output/test2.avi')
cap2 = cv2.VideoCapture('../output/test.avi')

title1 = 'Multi-domain'
title2 = 'Single-domain'
while(cap1.isOpened() and cap2.isOpened()):
    ...
    if ret1 == True: 
        ...
        cv2.putText(both, title1, (int(0.18*1280*2), 50), cv2.FONT_HERSHEY_SIMPLEX, 2, (0,0,255), 3, 0)
        cv2.putText(both, title2, (int(0.68*1280*2), 50), cv2.FONT_HERSHEY_SIMPLEX, 2, (0,0,255), 3, 0)
